# CE Suite — Licensing Progress

Track SPDX header application across all tracked files.
One file per session; commit between each; never batch.

Categories:
- **SPEC (CC BY 4.0)** — spec prose: .md chapters, charter, submission docs, appendices, glossary, reference text, .adoc mirrors
- **CODE (BSD-3-Clause)** — executable/build machinery: Makefile, scripts, future .sail files, CI config
- **SKIP (no header)** — LICENSE files, .gitignore, this file, generated build artifacts, docs/archive/ files
...
- [x] docs/chapters/ch01-execution-context-model.md
- [x] docs/chapters/ch02-bank-group-delegation.md
- [x] docs/chapters/ch03-cme-instruction-set.md
...
## UNCLASSIFIED
- [ ] docs/chapters/ch04-hardware-microarch.md
- [ ] docs/chapters/ch05-linux-integration.md
- [ ] docs/chapters/ch06-cme-usage-examples.md
...
- [ ] docs/chapters/ch11-qos-io-quality-of-service.md
