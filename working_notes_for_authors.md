...
### 3.5 Ask for brevity, but not at the cost of information

By default, AI assistants produce verbose responses. Verbosity is itself
a drift risk: it buries decisions inside prose, makes review harder, and
tempts you to skim. Skimming is where mistakes slip through.

When starting a session, tell the assistant: **"Be brief, but not so brief
that I start missing information."** This phrasing matters — pure "be
brief" pushes the assistant toward terse, choppy responses that omit the
*why*, and the why is exactly what you need when reviewing architectural
work.

The standard you're asking for: short answers when the question is
simple; reasoning when the reasoning matters; no padding, no preambles
("Great question!"), no recaps of what you just said back to you.

If a response is too long, say "shorter, please." If it's too terse,
say "expand on the reasoning for X." The assistant will calibrate.
Don't suffer in silence — verbose responses you didn't push back on
are responses you'll skim, and skim is the drift vector.
